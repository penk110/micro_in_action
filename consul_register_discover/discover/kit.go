...
func NewKitDiscover(consulHost string, consulPort uint64) (*KitDiscoverClient, error) {
	var (
...
func (kd *KitDiscoverClient) Register(serviceName, instanceId, healthCheckUrl string, instanceHost string, instancePort int, meta map[string]string, logger *log.Logger) bool {
	// TODO: 完善实例元数据
	// Check ?
